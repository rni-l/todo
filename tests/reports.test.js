...
test('buildReportSummary aggregates headline metrics and distributions', () => {
  const report = buildReportSummary({
    tasks: [
      ...
      { id: 't3', title: 'Soon', completed: false, dueDate: '2026-06-12', priority: 'low', projectId: null, urgent: false },
  ...
  assert.deepEqual(report.projectBreakdown, [
    { id: 'p1', name: 'Alpha', open: 2, completed: 1, overdue: 1 },
    { id: 'p2', name: 'Beta', open: 1, completed: 1, overdue: 0 }
  ]);
